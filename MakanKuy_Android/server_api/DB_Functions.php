...
class DB_Functions {
    ...
    public function simpanUser($email, $nama, $id_konsumen, $password, $no_telp) {
        $uuid = uniqid('', true);
        $hash = $this->hashSSHA($password);
        $encrypted_password = $hash["encrypted"]; // encrypted password
        $salt = $hash["salt"]; // salt
 
        $stmt = $this->conn->prepare("INSERT INTO konsumen(email, nama, id_konsumen, encrypted_password, salt,) VALUES(?, ?, ?, ?, ?)");
     ...
     */
    public function login($id_konsumen, $password) {
